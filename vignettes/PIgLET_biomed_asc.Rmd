...
4. Optional: Export ASC FASTA and Threshold Table

```{r, eval=FALSE}
fwrite(allele_table_frw1, "allele_threshold_table_ogrdb_frw1.tsv", sep = "\t", quote = FALSE)
writeFasta(asc_frw1@alleleClusterSet, "HVGERM_ogrdb_frw1_asc.fasta")
```

5. Load Precomputed Partial BIOMED Reference
...
6. Convert Annotations to ASC format
